...
export const SignUp = () => {
  ...
  const style = {
    ...
    <div>
        <AuthNavbar>
          <Link to={'/signin'}>
            <button className=" mt-auto px-7 py-2 bg-[#19303d] text-white font-normal rounded-md shadow-sm hover:bg-[#0fe5c0] transition duration-300 ease-in-out flex items-center justify-between">
                Sign In
            </button>
          </Link>
        </AuthNavbar>
        <div className="flex items-center justify-center h-screen">
            <div>
              <h2 className="text-center text-3xl font-bold text-[#19303d] mb-6">Sign up with a magic link</h2>
